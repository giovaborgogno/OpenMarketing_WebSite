<?php
require_once('inc/header/header.php');
            ...
            <div class="wpcf7">
                <form action="" method="POST" class="wpcf7-form">
                    <div class="faq-form row">
                        ...
                        <div class="g-recaptcha col-md-12 col-xs-12" data-sitekey="6LcxO3wiAAAAALwfrCogdmQRk3WVSfjpLH92V0I-" style="margin-bottom: 10px;"></div>
                       
                        <p class="text-center">

                            
                            <button id="submit" class="octf-btn octf-btn-icon octf-btn-primary">Send Message<i class="flaticon-right-arrow-1"></i></button>
                            <!-- <br/>
